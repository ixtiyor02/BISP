...
import watch1 from "@/public/review1.png";
import watch2 from "@/public/review2.png";
import watch3 from "@/public/review3.jpg";

const reviews = [
  {
    id: 1,
    rating: 5,
    text: "The Apple Watch Ultra 2's screen is excellent for activities and is easily one of the brightest and most defined. Interaction is well thought out, and even while on the move, the optional touchscreen or scrolling crown both respond accurately and without hassle.",
    author: "Giovanni",
    date: "Mar 20, 2025",
  ...
  },
  {
    id: 2,
    rating: 4,
    text: "The spinning bezel is a pleasure to use on the Galaxy Watch 6 Classic, making it easy to scroll through tiles and notifications from the watch face and quickly navigate other screens and menus on the watch",
  ...
  },
  {
    id: 3,
    rating: 5,
    text: "The Pixel Watch 3 gets a larger screen, making it easier to interact with apps and notifications. It's my favorite Android watch to date.",
