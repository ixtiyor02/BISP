...
import HeroImageFallback from "@/public/iwatch.jpg";
            ...
            <div className="md:w-3/5 p-6 md:p-8">
              ...
              <div className="flex items-center mb-6">
                <span className="text-3xl font-bold text-blue-600">
                  {/* ${featuredWatch1?.price.toLocaleString()} */}$199
                </span>
                <span className="text-xl text-gray-500 line-through ml-4">
                  {/* ${featuredWatch1?.originalPrice.toLocaleString()} */}$299
                </span>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                <div className="flex items-center">
                  ...
                  <span>
                    <strong>Brand:</strong>
                    {/* {featuredWatch1?.brand} */} Apple
                  </span>
                </div>
                <div className="flex items-center">
                  <Clock className="w-5 h-5 mr-2 text-blue-500" />
                  <span>
                    <strong>Movement:</strong> Battery
                  </span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span>
                    ...
                    {/* {featuredWatch1?.casematerial} */} Aluminum
                  </span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span>
                    <strong>Glass:</strong>
                    {/* {featuredWatch1?.glass} */} Stainless steel
                  </span>
                </div>
              </div>
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside text-sm text-gray-600 grid grid-cols-2 gap-2">
                  <li>
                    Band Size:
                    {/* {featuredWatch1?.bandsize} */} S/M
                  </li>

                  <li>
                    Condition:
                    {/* {featuredWatch1?.condition} */} Brand new
                  </li>
                </ul>
              </div>
              <div className="flex items-center text-sm text-gray-500 mb-6">
                ...
                <span className="flex items-center">
                  {/* {featuredWatch1?.averageRating.toFixed(1)} */}0.0
                  <Star className="w-4 h-4 text-yellow-400 ml-1" />
                </span>
                <span className="mx-2">|</span>
                <span>{/* {featuredWatch1?.numReviews} */}0 reviews</span>
              </div>
